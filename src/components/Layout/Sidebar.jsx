...
const menus = {
  USER: [
    ...
    { path: "/user/slot-reservations", label: "Đặt ô ô tô", icon: CalendarClock },
  ...
  PARKING_STAFF: [
    ...
    { path: "/staff/slot-reservations", label: "Đặt ô cho khách", icon: CalendarClock },
  ...
  PARKING_MANAGER: [
    ...
    { path: "/manager/staff-profiles", label: "Hồ sơ nhân viên", icon: IdCard },
    { path: "/manager/staff", label: "Đề nghị tạo Staff", icon: Users },
  ...
  ADMIN: [
    ...
    { path: "/admin/users", label: "Quản lý tài khoản", icon: UserCheck },
    { path: "/admin/vehicles", label: "Duyệt xe", icon: Car },
    { path: "/admin/staff-role-requests", label: "Duyệt tài khoản Staff", icon: Users },
