...
export const buildingInfo = {
  ...
  hotline: "1900 2208",
  description:
    "MVP vận hành một tòa nhà gửi xe bằng QR. Xe máy quản lý theo capacity, ô tô quản lý theo từng slot cụ thể.",
};
...
export const floors = [
  ...
  },
  {
    ...
    slotsCount: 36,
    status: "ACTIVE",
    note: "Gán slot cụ thể, staff xác nhận trước khi xe vào.",
  },
];
...
export const carSlots = Array.from({ length: 36 }, (_, index) => {
  ...
  return {
    ...
    note: status === "CONFLICT" ? "Staff cần kiểm tra thực tế và ghi nhận vi phạm nếu cần." : "",
  };
});
...
export const monthlyPackages = [
  ...
  { id: "PKG-CAR-VIP", name: "Gói ô tô slot ưu tiên", vehicleType: "CAR", price: 2400000, duration: "30 ngày" },
];
...
export const parkingSessions = [
  ...
  },
  {
    ...
    status: "ACTIVE",
    floorId: 1,
    floorName: "Tầng B1 - Xe máy cư dân",
    slotCode: null,
    qrCardId: "QR-MB-59S1-22345",
    checkInAt: "2026-06-11T09:00:00+07:00",
    checkOutAt: null,
    baseFee: 0,
    violationFee: 0,
    totalAmount: 0,
...
export const violations = [
  {
    ...
    plateNumber: "30H-123.88",
    vehicleType: "CAR",
    type: "Ô tô chiếm slot đã đặt trước",
    detectedAt: "2026-06-11T10:58:00+07:00",
    staffName: "Trần Bảo",
    fine: 300000,
    status: "UNPAID",
    note: "Xe đỗ sang C-33, ảnh hưởng slot đã đặt.",
  },
  {
    id: "VIO-02",
    sessionId: "SESS-1002",
...
export const getStatusTone = (status) => {
  ...
  if (["PENDING", "PENDING_PAYMENT", "PENDING_REVIEW", "RESERVED", "IN_USE", "WARNING"].includes(normalized)) return "warning";
  if (["REJECTED", "FAILED", "EXPIRED", "CANCELLED", "CONFLICT", "LOCKED", "MAINTENANCE", "UNPAID"].includes(normalized)) return "danger";
  return "neutral";
};
